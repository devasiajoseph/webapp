...
func saveApi(w http.ResponseWriter, r *http.Request) {
	...
	obj.Linkedin = api.CleanStringForm(r.FormValue("linkedin"))
	obj.Facebook = api.CleanStringForm(r.FormValue("facebook"))
	obj.Twitter = api.CleanStringForm(r.FormValue("twitter"))
	obj.Youtube = api.CleanStringForm(r.FormValue("youtube"))
	obj.Tiktok = api.CleanStringForm(r.FormValue("tiktok"))
